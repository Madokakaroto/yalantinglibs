...
option(YLT_ENABLE_ND "Enable NetworkDirect (ND) support (Windows-only)" ON)
if (YLT_ENABLE_ND AND NOT WIN32)
    message(STATUS "YLT_ENABLE_ND ignored: NetworkDirect is Windows-only")
    set(YLT_ENABLE_ND OFF)
endif ()
if (YLT_ENABLE_ND)
    # ND is header-only (bundles a header-only NetworkDirect SDK in
    # networkdirect.hpp); the only runtime deps are the Winsock libraries
    # (ws2_32, mswsock), linked per consuming target.
    message(STATUS "Enable NetworkDirect (ND) support")
    if(CMAKE_PROJECT_NAME STREQUAL "yaLanTingLibs")
